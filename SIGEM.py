...
def parse_args(graph='', dataset_name='', result_dir='output/', dimension=128, iterations=5, damping_factor=0.2, scaling_factor=-1,  
               gpu_on=True, bch_cpu=128, bch_gpu=128, prl_num=8,  epochs=100,
               learning_rate=-1, reg_rate=-1, early_stop=True, wait_thr=10, 
    ...
    parser.add_argument('--result_dir', nargs='?', default=result_dir, help='Destination to save the embedding result')   
