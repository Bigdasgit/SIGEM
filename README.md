...
**We optimized the implementation of LINOW-bn/TF**, reducing its execution time by approximately 45% with all datasets, compared to the values reported in Table 4 of the paper.
