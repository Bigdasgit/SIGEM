...
**We improved the implementation of LINOW-bn/TF**, reducing its execution time by approximately 45% compared with the values reported in Table 4 of the paper, with all datasets.
